        ...
        <div className="max-w-360 mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden lg:flex items-center gap-10">
              {["Novidades", "Coleções", "Presentes"].map((item) => (
                <Link
                  key={item}
                  href="#"
            ...
            <div className="hidden lg:flex items-center gap-8">
              ...
              <button
                ...
                <span className="absolute -top-2 -right-2 w-4 h-4 bg-primary text-primary-foreground text-[9px] flex items-center justify-center">
                  0
                </span>
              </button>
            </div>
